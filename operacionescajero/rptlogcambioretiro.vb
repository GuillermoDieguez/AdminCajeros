...
Public Class rptlogcambioretiro
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "admincajeros.rptlogcambioretiro.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedrptlogcambioretiro
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptlogcambioretiro = New rptlogcambioretiro
        rpt.Site = Me.Site
        Return rpt
    End Function
