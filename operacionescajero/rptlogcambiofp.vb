...
Public Class rptlogcambiofp
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "admincajeros.rptlogcambiofp.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedrptlogcambiofp
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptlogcambiofp = New rptlogcambiofp
        rpt.Site = Me.Site
        Return rpt
    End Function
