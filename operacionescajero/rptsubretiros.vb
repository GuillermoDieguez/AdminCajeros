...
Public Class rptsubretiros
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "admincajeros.rptsubretiros.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedrptsubretiros
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptsubretiros = New rptsubretiros
        rpt.Site = Me.Site
        Return rpt
    End Function
